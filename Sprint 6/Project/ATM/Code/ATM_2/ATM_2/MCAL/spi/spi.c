...
#include "spi.h"
#include "../../mcal/dio/dio.h"				/* To Setup the SPI pins direction */
#include "../../utilities/bit_math.h"		/* To use the macros like SET_BIT */
...
void SPI_initMaster(void) 
{
	 ...
	 * SCK(PB7) --> Output
	 ********************************************/
	dio_init(PORT_B,PINB4,DIO_OUT);
	dio_init(PORT_B,PINB5,DIO_OUT);
	dio_init(PORT_B,PINB6,DIO_IN);
	dio_init(PORT_B,PINB7,DIO_OUT);
