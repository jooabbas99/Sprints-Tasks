...
#include "spi.h"
#include "../../MCAL/DIO/GPIO.h"				/* To Setup the SPI pins direction */
...
void SPI_initMaster(void) 
{
	 ...
	 * SCK(PB7) --> Output
	 ********************************************/
	GPIO_setPinDirection(PORTB_ID,PIN4,PIN_OUTPUT);
	GPIO_setPinDirection(PORTB_ID,PIN5,PIN_OUTPUT);
	GPIO_setPinDirection(PORTB_ID,PIN6,PIN_INPUT);
	GPIO_setPinDirection(PORTB_ID,PIN7,PIN_OUTPUT);
...
{ 
	 ...
	 * SCK(PB7) --> Input
	 ********************************************/
	GPIO_setPinDirection(PORTB_ID,PIN4,PIN_INPUT);
	GPIO_setPinDirection(PORTB_ID,PIN5,PIN_INPUT);
	GPIO_setPinDirection(PORTB_ID,PIN6,PIN_OUTPUT);
	GPIO_setPinDirection(PORTB_ID,PIN7,PIN_INPUT);
